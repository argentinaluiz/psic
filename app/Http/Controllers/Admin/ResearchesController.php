...
class ResearchesController extends Controller
{
    ...
    public function index()
    {
        if(Gate::denies('researches-view')){
          ...
          return view('admin.researches.index',compact('researches', 'totalResearches'));
    }
    ...
    public function category($id)
    {
       ...
       return view('admin.researches.category', compact('research', 'category', 'form'));
    }
    ...
    public function create()
    {
        if(Gate::denies('researches-create')){
          ...
          return view('admin.researches.create',compact('form'));
    }
    ...
    public function edit(Research $research)
    {
        ...
        $form = \FormBuilder::create(ResearchForm::class, [
          ...
          return view('admin.researches.edit',compact('form', 'research'));
    ...
    public function indexArcade(Research $research)
    {
      ...
      return view('admin.researches.arcade',compact('registros','research', 'form'));
    }
    ...
    public function createArcade(Research $research)
    {
      ...
      return view('admin.researches.documents',compact('documents','research','documentsResearch'));
    }
    ...
    public function editArcade(Arcade $arcade)
    {
      ...
      return view('admin.researches.arcade.edit',compact('registro'));
    }
